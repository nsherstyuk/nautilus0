"""
Run MTF V2 backtest with Entry Confirmation, DMI Relative Filter, and Dynamic Sizing.

This combines the best features:
- DMI relative strength filtering (94.2% win rate from DMI relative)
- Dynamic position sizing ($45,966 P&L from dynamic sizing)
- Entry confirmation logic

Output folder: MTF_V2_DMI_RELATIVE_DYNAMIC_{timestamp}
"""
...
def run_v2_entry_confirmed_dmi_relative_dynamic_backtest(
    symbol: str = "EUR/USD",
    venue: str = "IDEALPRO",
    ...
    print("=" * 80)
    print("MTF V2 Entry Confirmed + DMI Relative + Dynamic Sizing Backtest")
    print("=" * 80)
    print(f"Symbol: {symbol}")
    print(f"Venue: {venue}")
    print(f"Period: {start_date} to {end_date}")
    print(f"Dynamic Sizing: Enabled")
    print(f"DMI Relative Filter: Enabled")
    print(f"Entry Confirmation: enabled={entry_confirmation_enabled} "
    ...
    output_dir = PROJECT_ROOT / "backtest_results" / f"MTF_V2_DMI_RELATIVE_DYNAMIC_{timestamp}"
    ...
    strategy_config = ImportableStrategyConfig(
        ...
        config={
            ...
            "margin_per_100k_usd": 3200.0,
            "target_margin_usage": 0.35,
...
def main():
    ...
    # Run backtest
    result, results_dir = run_v2_entry_confirmed_dmi_relative_dynamic_backtest(
        symbol=config.symbol,
        venue=config.venue,
    ...
    print()
    print("=" * 80)
    print("MTF V2 DMI RELATIVE + DYNAMIC SIZING BACKTEST COMPLETED")
    print("=" * 80)
    print(f"Results: {results_dir}")
    print()
    print("Next steps:")
    print("1. Review performance metrics in summary.txt")
    print("2. Compare with individual component backtests")
    print("3. If improved, consider this as new baseline")
