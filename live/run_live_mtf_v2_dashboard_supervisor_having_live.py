...
logger = logging.getLogger("live_v2_dashboard_supervisor_having_live")
...
def _load_config() -> SupervisorConfig:
    project_root = Path(__file__).resolve().parent.parent
    child_script = project_root / "live" / "run_live_mtf_v2_dashboard_having_live.py"
...
def _setup_logging() -> None:
    ...
    try:
        ...
        log_and_write_run_metadata(
            ...
            run_id=run_id,
            entrypoint=__file__,
            extra={"logger": "live_v2_dashboard_supervisor_having_live"},
        )
    except Exception:
        pass
