...
MODEL_STEM = "meta_model_breakout_eurusd"
INPUT_FILE  = DATA_DIR / "meta_labeled_1000t_breakout.parquet"
...
XGB_PARAMS = dict(
    ...
    eval_metric="logloss",
    max_depth=5,              # Relaxed from 4
    learning_rate=0.05,
    n_estimators=200,
    subsample=0.8,
    colsample_bytree=0.8,
    min_child_weight=1,       # Relaxed from 5
