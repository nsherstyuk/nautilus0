...
def run_v2_entry_confirmed_backtest(
    ...
    strategy_config = ImportableStrategyConfig(
        strategy_path="strategies.ml_strategy_mtf_v2_entry_confirmed_dmi_relative:MLSignalStrategyV2EntryConfirmed",
        config_path="strategies.ml_strategy_mtf_v2_entry_confirmed_dmi_relative:MLSignalStrategyV2EntryConfirmedConfig",
        config={
