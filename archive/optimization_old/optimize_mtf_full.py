"""
Comprehensive MTF Strategy Optimization.
...
def main():
    print("="*80)
    print("MTF COMPREHENSIVE OPTIMIZATION")
    print("Optimizing: Partial Close + Trailing Stop Parameters")
    print("="*80)
    ...
    activation_range = [1.5, 2.0, 2.5, 3.0]     # When to start trailing (focus on best from previous)
    distance_range = [0.5, 0.8, 1.0]            # How far to trail (focus on best from previous)
    ...
    # Save to CSV
    output_path = PROJECT_ROOT / "optimization_full_results.csv"
